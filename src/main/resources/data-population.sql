...
INSERT INTO nma.formulario (ap_paterno, ap_materno, nombres_trabajador, profesion, cargo, edad, sexo, anno_antiguedad, fecha_episodio, hora_episodio, region, ubicacion_o_faena, area, ubicacion_exacta, nombre_jefatura, activdad_realizada, lugar_especifico_episodio, tipo_episodio, accion_insegura, condicion_insegura, causas, testigos, cargo_testigo, elaborador_informe, cargo_elaborador_informe, nombre_revisador, cargo_revisador, fecha_revision, anexos, id_cliente, folio, rut_trabajador) VALUES ('Perez', 'Pereira', 'Juan', 'Ingeniero', 'KAM', 40, 'M', 10, '2023-05-17', '2023-05-17', 'Metropolitana', 'Casa Matriz', 'Primer Piso', 'Cocina', 'Jefecito', 'Uso Hervidor', 'Cocina Coopeuch', 'Accidente', 'Si', 'Si', 'Mala conexion electrica', 'Jefecito', 'Jefatura', 'Juan Perez', 'KAM', '2023-05-18', 'Revisador 1', 'Revisador', '2023-05-18', null, '5', 1, '111111111-1');
...
INSERT INTO nma.servicio (id_servicio, nombre_servicio, valor_servicio, descripcion_servicio, fecha_creacion_servicio, fecha_baja_servicio, id_cliente, id_persona, estado_servicio) VALUES (1, 'Capacitacion Prueba', 1000000, 'Capacitacion Coopeuch', '2023-05-19', '2023-05-31', '5', '1', 'A');
...
INSERT INTO nma.visita (fecha_visita, descripcion_visita, nombre_profesional, estado, persona_run_persona, id_visita, id_empresa, valor) VALUES ('2023-05-29', 'Visita Prueba', 'Profesional 1', 'A', '92970696-k', 1, '5', '120000');
